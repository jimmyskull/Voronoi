...
public:
	 ...
	 */
	unsigned int createEdge(Vertex* origin, Face* face, Vertex* twinOrigin,
			Face* twinFace);
	 ...
	 */
	unsigned int createTriangularFace(unsigned int vId1, unsigned int vId2,
			unsigned int vId3);
...
template<class Vdt, class Hdt, class Fdt>
unsigned int DCEL<Vdt, Hdt, Fdt>::createVertex()
{
...
template<class Vdt, class Hdt, class Fdt>
VertexT<Vdt, Hdt, Fdt>* DCEL<Vdt, Hdt, Fdt>::createGetVertex()
{
	this->vertices.push_back(Vertex());
...
template<class Vdt, class Hdt, class Fdt>
unsigned int DCEL<Vdt, Hdt, Fdt>::createFace(HalfEdge* bound)
{
...
template<class Vdt, class Hdt, class Fdt>
unsigned int DCEL<Vdt, Hdt, Fdt>::createEdge(Vertex* origin, Face* face,
		Vertex* twinOrigin, Face* twinFace)
{
...
template<class Vdt, class Hdt, class Fdt>
unsigned int DCEL<Vdt, Hdt, Fdt>::createTriangularFace(unsigned int vId1,
		unsigned int vId2, unsigned int vId3)
{
	...
	//point to a new face. A easy case =)
		...
		if (e1->getFace() == NULL && e2->getFace() == NULL
				&& e3->getFace() == NULL) {
			if (e1->getNext() == e2 && e2->getNext() == e3
					&& e3->getNext() == e1) {
				faceId = createFace(e1);
				face = getFace(faceId);
				e1->setFace(face);
...
template<class Vdt, class Hdt, class Fdt>
VertexT<Vdt, Hdt, Fdt>* DCEL<Vdt, Hdt, Fdt>::getVertex(unsigned int id) const
{
...
template<class Vdt, class Hdt, class Fdt>
std::vector<VertexT<Vdt, Hdt, Fdt> >& DCEL<Vdt, Hdt, Fdt>::getVertices()
{
	return this->vertices;
}

template<class Vdt, class Hdt, class Fdt>
const std::vector<VertexT<Vdt, Hdt, Fdt> >& DCEL<Vdt, Hdt, Fdt>::getVertices() const
{
	return this->vertices;
}

template<class Vdt, class Hdt, class Fdt>
unsigned int DCEL<Vdt, Hdt, Fdt>::getNumVertices() const
{
	return this->vertices.size();
}

template<class Vdt, class Hdt, class Fdt>
unsigned int DCEL<Vdt, Hdt, Fdt>::getVertexId(const Vertex* vertex) const
{
...
template<class Vdt, class Hdt, class Fdt>
std::vector<FaceT<Vdt, Hdt, Fdt> >& DCEL<Vdt, Hdt, Fdt>::getFaces()
{
	return this->faces;
}

template<class Vdt, class Hdt, class Fdt>
const std::vector<FaceT<Vdt, Hdt, Fdt> >& DCEL<Vdt, Hdt, Fdt>::getFaces() const
{
	return this->faces;
}
...
template<class Vdt, class Hdt, class Fdt>
FaceT<Vdt, Hdt, Fdt>* DCEL<Vdt, Hdt, Fdt>::getFace(unsigned int faceId) const
{
...
template<class Vdt, class Hdt, class Fdt>
unsigned int DCEL<Vdt, Hdt, Fdt>::getFaceId(const Face* face) const
{
...
template<class Vdt, class Hdt, class Fdt>
inline std::vector<HalfEdgeT<Vdt, Hdt, Fdt> >& DCEL<Vdt, Hdt, Fdt>::getHalfEdges()
{
	return this->edges;
}

template<class Vdt, class Hdt, class Fdt>
inline const std::vector<HalfEdgeT<Vdt, Hdt, Fdt> >& DCEL<Vdt, Hdt, Fdt>::getHalfEdges() const
{
	return this->edges;
}

template<class Vdt, class Hdt, class Fdt>
HalfEdgeT<Vdt, Hdt, Fdt>* DCEL<Vdt, Hdt, Fdt>::getHalfEdge(unsigned int id)
{
...
template<class Vdt, class Hdt, class Fdt>
const HalfEdgeT<Vdt, Hdt, Fdt>* DCEL<Vdt, Hdt, Fdt>::getHalfEdge(
...
template<class Vdt, class Hdt, class Fdt>
HalfEdgeT<Vdt, Hdt, Fdt>* DCEL<Vdt, Hdt, Fdt>::getHalfEdge(Vertex* vertexA,
...
template<class Vdt, class Hdt, class Fdt>
HalfEdgeT<Vdt, Hdt, Fdt>* DCEL<Vdt, Hdt, Fdt>::getHalfEdge(
		unsigned int vertexIdA, unsigned int vertexIdB) const
{
	return getHalfEdge(getVertex(vertexIdA), getVertex(vertexIdB));
}

template<class Vdt, class Hdt, class Fdt>
unsigned int DCEL<Vdt, Hdt, Fdt>::getHalfEdgeId(HalfEdge* halfEdge) const
{
...
template<class Vdt, class Hdt, class Fdt>
unsigned int DCEL<Vdt, Hdt, Fdt>::getNumHalfEdges() const
{
...
template<class Vdt, class Hdt, class Fdt>
void DCEL<Vdt, Hdt, Fdt>::checkFace(unsigned int faceId) const
{
...
template<class Vdt, class Hdt, class Fdt>
int DCEL<Vdt, Hdt, Fdt>::getNumUnhandledTriangles() const
{
	return this->unhandledTrianglesCount;
}

template<class Vdt, class Hdt, class Fdt>
HalfEdgeT<Vdt, Hdt, Fdt>* DCEL<Vdt, Hdt, Fdt>::findIncidentHalfEdge(
		Vertex* vertex)
{
